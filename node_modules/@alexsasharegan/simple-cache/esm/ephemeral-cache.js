 ...
 * expiration purge.
 */
export function EphemeralCache(capacity, durationMs, typeLabel = { key: "any", value: "any" }) {
    ...
    const { clear, entries, get_store, invalidate, keys, remove, size, values, write, } = CoreCache(capacity, { itemFactory });
