...
class Task {
    ...
    fork(resolver) {
        ...
        return new Promise((resolve) => this.executor({
            Ok: (okValue) => resolve(result_1.Result.Ok(mapOk(okValue))),
            Err: (errValue) => resolve(result_1.Result.Err(mapErr(errValue))),
        }));
    }
    /**
    ...
    run_sync() {
        ...
        this.executor({
            Ok(value) {
                r = result_1.Result.Ok(value);
            },
            Err(err) {
                r = result_1.Result.Err(err);
            },
        });
